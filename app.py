...
if user_data:
    ...
    if prompt := st.chat_input("Zadaj pytanie DeepTrace..."):
        # Przygotowanie treści użytkownika (tekst + opcjonalnie obraz)
    ...
    # --- 5. WIDOK DLA NIEZALOGOWANEGO ---
    st.markdown('<h1 class="main-title">DeepTrace Alpha</h1>', unsafe_allow_html=True)
    st.info("System wymaga autoryzacji. Zaloguj się lub załóż konto, aby kontynuować.")
